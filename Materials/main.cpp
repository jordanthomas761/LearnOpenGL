...
//  Materials
//
//  Created by Jordan Thomas on 12/25/18.
...
int main(int argc, const char * argv[]) {
	...
	while(!glfwWindowShouldClose(window)){
		...
		lightingShader.setVector3("light.ambient", 1.0f, 1.0f, 1.0f);
		lightingShader.setVector3("light.diffuse", 1.0f, 1.0f, 1.0f);
		lightingShader.setVector3("light.specular", 1.0f, 1.0f, 1.0f);
		
		lightingShader.setVector3("material.ambient", 0.0f, 0.1f, 0.06f);
		lightingShader.setVector3("material.diffuse", 0.0f, 0.50980392f, 0.50980392f);
		lightingShader.setVector3("material.specular", 0.50196078f, 0.50196078f, 0.50196078f);
