...
static void update(unsigned int cubeVAO, unsigned int diffuseMap, unsigned int lightVAO, Shader &lightingShader, Shader &lampShader, unsigned int specularMap, GLFWwindow *window) {
	while(!glfwWindowShouldClose(window)){
        ...
        lightingShader.setVector3("spotLight.ambient", 0.1f, 0.1f, 0.1f);
        lightingShader.setVector3("spotLight.diffuse", 0.8f, 0.8f, 0.8f);
...
int main(int argc, const char * argv[]) {
	...
	update(cubeVAO, diffuseMap, lightVAO, lightingShader, lampShader, specularMap, window);
